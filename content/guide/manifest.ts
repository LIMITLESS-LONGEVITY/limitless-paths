...
export const guideRoles: GuideRole[] = [
  {
    ...
    topics: [
      ...
      { slug: 'using-search', title: 'Using Search', description: 'Find content with semantic search' },
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'certificates', title: 'Course Certificates', description: 'Earn certificates upon course completion' },
