# Reviewing & Publishing <span class="badge-editor">Editors / Publishers</span>

As an editor or publisher, you ensure every article meets PATHS quality standards before it reaches readers. Both of your internal team roles can perform all the actions described here.

=== "Reviewing"

    ## Finding Articles to Review

    Go to **Articles** in the dashboard and filter by **In Review** status. These are articles submitted by authors and awaiting your assessment.
    ...
    If the article meets your standards, click **Approve**. The article moves to **Approved** status — ready for publishing.
